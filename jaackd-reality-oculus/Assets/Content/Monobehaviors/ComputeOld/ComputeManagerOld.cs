...
namespace jaackdold {
  ...
  public class ComputeManagerOld : MonoBehaviour {
    ...
    private void Update() {
      ...
      //  Utilities.PrintIfEditor("Sucessfully added perVertexData buffer");
      //} else {
      //  Utilities.PrintIfEditor("Failed to load perVertexData buffer");
      //}

      //material.SetBuffer("modelVertices", modelVerticesComputeBuffer);
      //if (material.HasBuffer("modelVertices")) {
      //  Utilities.PrintIfEditor("Sucessfully added modelVertices buffer");
      //} else {
      //  Utilities.PrintIfEditor("Failed to load modelVertices buffer");
      //}

      //material.SetBuffer("perInstanceData", perInstanceComputeBuffer);
      //if (material.HasBuffer("perInstanceData")) {
      //  Utilities.PrintIfEditor("Sucessfully added perInstanceData buffer");
      //} else {
      //  Utilities.PrintIfEditor("Failed to load perInstanceData buffer");
      //}
      ...
      //  Utilities.PrintIfEditor("Sucessfully added ViewProjectionConstantBuffer");
      //} else {
      //  Utilities.PrintIfEditor("Failed to load ViewProjectionConstantBuffer");
      //}
